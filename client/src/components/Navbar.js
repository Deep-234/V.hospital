      ...
      return [
        <li key="1">
          <div className="tooltip">
            ...
            <span className="tooltiptext">Search User</span>
          </div>
        </li>,
        <li className="homebtn" key="2">
          <Link to="/">
            <div className="tooltip">
        ...
        //       <span className="tooltiptext">Following</span>
        //     </div>
        //   </Link>
        // </li>,
        <li key="5">
          <Link to="/profile">
            <div className="tooltip">
              ...
              <span className="tooltiptext">My Profile</span>
            </div>
          </Link>
        </li>,
        <li key="6">
